...
public class ContainerMorbus_Chest extends Container 
{
	private final int numRows;
	private final TileEntityMorbus_Chest chestInventory;

	public ContainerMorbus_Chest(InventoryPlayer playerInv, TileEntityMorbus_Chest chestInventory, EntityPlayer player) 
	{
	...
	public TileEntityMorbus_Chest getChestInventory() 
	{
