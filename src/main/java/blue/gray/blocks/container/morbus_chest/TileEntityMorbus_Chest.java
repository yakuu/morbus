...
public class TileEntityMorbus_Chest extends TileEntityLockableLoot implements ITickable {
	...
	{
		return this.hasCustomName() ? this.customName : "Morbus Chest";
	}
	...
	{
		return Reference.MOD_ID + "morbus_chest";
	}
