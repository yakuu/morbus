...
public class ContainerMorbusChest extends Container 
{
	private final int numRows;
	private final TileEntityMorbus_Chest chestInventory;

	public ContainerMorbusChest(InventoryPlayer playerInv, TileEntityMorbus_Chest chestInventory, EntityPlayer player) 
	{
